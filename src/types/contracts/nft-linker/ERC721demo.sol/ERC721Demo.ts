...
export interface ERC721DemoInterface extends utils.Interface {
  functions: {
    ...
    "mintWithMetadata(uint256,string,string)": FunctionFragment;
...
export interface ERC721Demo extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721DemoInterface;
