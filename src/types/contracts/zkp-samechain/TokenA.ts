...
export interface TokenAInterface extends utils.Interface {
  functions: {
    ...
    "sendData(address,uint256)": FunctionFragment;
    "setTokenBridge(address)": FunctionFragment;
  ...
  events: {
    ...
    "DataSent(address,address,uint256)": EventFragment;
...
export interface TokenA extends BaseContract {
  ...
  filters: {
    ...
    "DataSent(address,address,uint256)"(
