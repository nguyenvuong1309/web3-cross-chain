...
export interface IAxelarGasServiceInterface extends utils.Interface {
  ...
  getEvent(
    nameOrSignatureOrTopic: "NativeGasPaidForExpressCall"
  ): EventFragment;
  getEvent(
...
export type GasPaidForExpressCallEventFilter =
  TypedEventFilter<GasPaidForExpressCallEvent>;
...
export type NativeGasPaidForExpressCallEventFilter =
  TypedEventFilter<NativeGasPaidForExpressCallEvent>;
...
export interface IAxelarGasService extends BaseContract {
  ...
  filters: {
    ...
    "GasPaidForExpressCall(address,string,string,bytes32,address,uint256,address)"(
      ...
      gasFeeAmount?: null,
      refundAddress?: null
    ): GasPaidForExpressCallEventFilter;
    ...
    "NativeGasPaidForExpressCall(address,string,string,bytes32,uint256,address)"(
      ...
      gasFeeAmount?: null,
      refundAddress?: null
    ): NativeGasPaidForExpressCallEventFilter;
    ...
    "Refunded(bytes32,uint256,address,address,uint256)"(
      txHash?: PromiseOrValue<BytesLike> | null,
      logIndex?: PromiseOrValue<BigNumberish> | null,
      receiver?: null,
      token?: null,
