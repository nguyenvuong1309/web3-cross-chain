...
//   path.resolve(
//     __dirname,
//     "../../artifacts/contracts/sendMessageSameChain/sendMessageSameChain.sol/Messaging.json"
//   ),
//   "utf8"
// );
...
//   console.log("Send message same chain deployed to:", sendTransaction.address);
...
//   const key = "NEXT_PUBLIC_SEND_MESSAGE_SAME_CHAIN_CONTRACT_ADDRESS";
//   let updated = false;
...
//   console.log(`Send message same chain address saved to .env file: ${address}`);
// }
